...
class GalleriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gallery" do
    assert_difference('Gallery.count') do
      post galleries_url, params: { gallery: { address: @gallery.address, body: @gallery.body, image: @gallery.image, name: @gallery.name, nearest_tube: @gallery.nearest_tube } }
    end
  ...
  test "should update gallery" do
    patch gallery_url(@gallery), params: { gallery: { address: @gallery.address, body: @gallery.body, image: @gallery.image, name: @gallery.name, nearest_tube: @gallery.nearest_tube } }
