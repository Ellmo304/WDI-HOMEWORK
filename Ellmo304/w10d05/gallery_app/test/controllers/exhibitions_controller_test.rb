...
class ExhibitionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create exhibition" do
    assert_difference('Exhibition.count') do
      post exhibitions_url, params: { exhibition: { artist: @exhibition.artist, body: @exhibition.body, closing_date: @exhibition.closing_date, image: @exhibition.image, name: @exhibition.name, opening_date: @exhibition.opening_date } }
    end
  ...
  test "should update exhibition" do
    patch exhibition_url(@exhibition), params: { exhibition: { artist: @exhibition.artist, body: @exhibition.body, closing_date: @exhibition.closing_date, image: @exhibition.image, name: @exhibition.name, opening_date: @exhibition.opening_date } }
